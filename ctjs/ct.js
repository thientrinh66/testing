...
ct.inputs.addAction('Pointer', [{"code":"mouse.Left"}]);
...
ct.rooms.templates['HolericAliens'] = {
    name: 'HolericAliens',
    width: 1640,
    height: 900,
    /* JSON.parse allows for a much faster loading of big objects */
    objects: JSON.parse('[{"x":905,"y":770,"exts":{},"template":"WoodenSquare"},{"x":905,"y":700,"exts":{},"template":"WoodenSquare"},{"x":905,"y":630,"exts":{},"template":"WoodenSquare"},{"x":980,"y":560,"exts":{},"template":"WoodenPlank"},{"x":1054,"y":770,"exts":{},"template":"WoodenSquare"},{"x":1054,"y":700,"exts":{},"template":"WoodenSquare"},{"x":1054,"y":630,"exts":{},"template":"WoodenSquare"},{"x":980,"y":766,"exts":{},"template":"AlienTarget"},{"x":1050,"y":490,"exts":{},"template":"WoodenSquare"},{"x":980,"y":490,"exts":{},"template":"AlienTarget"},{"x":1120,"y":350,"exts":{},"template":"WoodenPlank"},{"x":1190,"y":420,"exts":{},"template":"WoodenSquare"},{"x":1190,"y":490,"exts":{},"template":"WoodenSquare"},{"x":1190,"y":700,"exts":{},"template":"WoodenSquare"},{"x":1190,"y":770,"exts":{},"template":"WoodenSquare"},{"x":1260,"y":630,"exts":{},"template":"WoodenPlank"},{"x":1330,"y":700,"exts":{},"template":"WoodenSquare"},{"x":1330,"y":770,"exts":{},"template":"WoodenSquare"},{"x":1120,"y":280,"exts":{},"template":"WoodenSquare"},{"x":1190,"y":560,"exts":{},"template":"WoodenSquare"},{"x":1288,"y":559,"exts":{},"template":"AlienTarget"},{"x":910,"y":840,"exts":{},"template":"grass"},{"x":980,"y":840,"exts":{},"template":"grass"},{"x":1050,"y":840,"exts":{},"template":"grass"},{"x":1120,"y":840,"exts":{},"template":"grass"},{"x":1190,"y":840,"exts":{},"template":"grass"},{"x":1260,"y":840,"exts":{},"template":"grass"},{"x":1330,"y":840,"exts":{},"template":"grass"},{"x":1400,"y":840,"exts":{},"template":"grass"},{"x":1470,"y":840,"exts":{},"template":"grass"},{"x":1540,"y":840,"exts":{},"template":"grass"},{"x":1610,"y":840,"exts":{},"template":"grass"},{"x":840,"y":840,"exts":{},"template":"grass"},{"x":770,"y":840,"exts":{},"template":"grass"},{"x":700,"y":840,"exts":{},"template":"grass"},{"x":560,"y":840,"exts":{},"template":"grass"},{"x":630,"y":840,"exts":{},"template":"grass"},{"x":490,"y":840,"exts":{},"template":"grass"},{"x":420,"y":840,"exts":{},"template":"grass"},{"x":350,"y":840,"exts":{},"template":"grass"},{"x":280,"y":840,"exts":{},"template":"grass"},{"x":210,"y":840,"exts":{},"template":"grass"},{"x":140,"y":840,"exts":{},"template":"grass"},{"x":70,"y":840,"exts":{},"template":"grass"},{"x":0,"y":840,"exts":{},"template":"grass"},{"x":1680,"y":840,"exts":{},"template":"grass"},{"x":1120,"y":210,"exts":{},"template":"WoodenTriangle"},{"x":1024,"y":278,"exts":{},"template":"AlienTarget"},{"x":700,"y":140,"exts":{},"template":"elementMetal013"},{"x":630,"y":70,"exts":{},"template":"elementMetal011"},{"x":770,"y":70,"exts":{},"template":"elementMetal011"},{"x":225,"y":646,"exts":{},"template":"Slingshot"},{"x":568,"y":770,"exts":{},"template":"WoodenTriangle"},{"x":700,"y":770,"exts":{},"template":"WoodenTriangle"},{"x":1050,"y":420,"exts":{},"template":"WoodenSquare"},{"x":630,"y":700,"exts":{},"tx":2.2,"ty":1,"template":"elementMetal011"}]'),
    bgs: JSON.parse('[{"depth":-10,"texture":"colored_grass","extends":{}}]'),
...
ct.matter.on('collisionStart', e => {
    ...
    for (const pair of e.pairs) {
        ...
        // We will use it for damage calculation to aliens and wooden blocks
        ...
        for (const body of bodies) {
            // Does a body belong to a copy of template "AlienTarget"?
            if (body.copy.template === 'AlienTarget') {
                // If it was too strong, destroy the alien.
                if (impact > 75) {
                    body.copy.kill = true;
                }
            }

            // Apply cumulative damage for wooden blocks
            // Tags are set in templates' On Create code
            if (body.copy.tag === 'Wooden') {
                // Ignore weak strikes
                if (impact >= 25) {
                    // I apply a damage multiplier 0.35 bc initial values turned out to be too destructive,
                    // and I'm too lazy to walk over three blocks and change damage thresholds there.
                    body.copy.damage += impact * 0.35;
                    // Texture change and destruction are coded in templates' On Step and Draw events.
                }
            }

            // Play sounds on considerable collisions
            if (impact >= 25) {
                if (body.copy.tag) {
                    ct.sound.spawn('Impact_' + body.copy.tag);
                }
            }
        }
    }
...
ct.templates.templates["Alien_Launched"] = {
    depth: 0,
    blendMode: PIXI.BLEND_MODES.NORMAL,
    playAnimationOnStart: false,
    texture: "alienGreen_round",
    onStep: function () {
        this.timeout--;
if (this.timeout <= 0) {
    this.kill = true;
...
this.timeout = ct.speed * 5;
    },
    extends: {
    "matterEnable": true,
    "matterRestitution": 0.7,
    "matterMass": 5,
    "matterDensity": 0.003
}
};
ct.templates.list['Alien_Launched'] = [];
ct.templates.templates["AlienTarget"] = {
    depth: 0,
    blendMode: PIXI.BLEND_MODES.NORMAL,
    playAnimationOnStart: false,
    texture: "alienPink_square",
    onStep: function () {
        this.move();
    },
    onDraw: function () {
...
ct.templates.list['AlienTarget'] = [];
ct.templates.templates["WoodenSquare"] = {
    depth: 0,
    blendMode: PIXI.BLEND_MODES.NORMAL,
    playAnimationOnStart: false,
    texture: "WoodenSquare",
    onStep: function () {
        if (this.damage > 150) {
    this.kill = true;
}
    ...
    onDraw: function () {
        if (this.damage > 75 && this.tex !== 'WoodenSquare_damaged') {
    this.tex = 'WoodenSquare_Damaged';
}
    },
    onDestroy: function () {
        ct.emitters.fire('FX_Burst', this.xprev, this.yprev, {
...
this.damage = 0;
    ...
    extends: {
    "matterEnable": true,
    "matterRestitution": 0.4,
    "matterFriction": 10,
    "matterFrictionStatic": 3.1,
    "matterFrictionAir": 0.05,
    "matterMass": 1
}
};
ct.templates.list['WoodenSquare'] = [];
ct.templates.templates["WoodenPlank"] = {
    depth: 0,
    blendMode: PIXI.BLEND_MODES.NORMAL,
    playAnimationOnStart: false,
    texture: "WoodenPlank",
    ...
    onDraw: function () {
        if (this.damage > 100 && this.tex !== 'WoodenPlank_damaged') {
...
ct.templates.templates["WoodenTriangle"] = {
    depth: 0,
    blendMode: PIXI.BLEND_MODES.NORMAL,
    playAnimationOnStart: false,
    texture: "WoodenTriangle",
    onStep: function () {
        if (this.damage > 250) {
    this.kill = true;
}
    ...
    onDraw: function () {
        if (this.damage > 100 && this.tex !== 'WoodenTriangle_damaged') {
    this.tex = 'WoodenTriangle_Damaged';
}
    },
    onDestroy: function () {
        ct.emitters.fire('FX_Burst', this.xprev, this.yprev, {
...
ct.templates.list['WoodenTriangle'] = [];
ct.templates.templates["Slingshot"] = {
    depth: 0,
    blendMode: PIXI.BLEND_MODES.NORMAL,
    playAnimationOnStart: false,
    texture: "Slingshot",
    onStep: function () {
        if (ct.actions.Pointer.pressed && ct.mouse.hovers(this)) {
    ct.templates.copy('Alien_Dragging', this.x, this.y);
}
    },
    onDraw: function () {
...
ct.templates.list['Slingshot'] = [];
ct.templates.templates["Alien_Dragging"] = {
    depth: 0,
    blendMode: PIXI.BLEND_MODES.NORMAL,
    playAnimationOnStart: false,
    texture: "alienGreen_round",
    onStep: function () {
        if (ct.actions.Pointer.released) {
    const speedModifier = 0.3,
          maxSpeed = 50;
    this.kill = true;
    const missile = ct.templates.copy('Alien_Launched', this.x, this.y);
    const slingshot = ct.templates.list['Slingshot'][0];
    var hspeed = (slingshot.x - this.x) * speedModifier,
        vspeed = (slingshot.y - this.y) * speedModifier,
        l = ct.u.pdc(0, 0, hspeed, vspeed);
    if (l > maxSpeed) {
        hspeed /= l / maxSpeed;
        vspeed /= l / maxSpeed;
    }
    ct.matter.launch(missile, hspeed, vspeed);
}
    },
    onDraw: function () {
        const slingshot = ct.templates.list['Slingshot'][0],
      maxLength = 150;
let dx = ct.mouse.x - slingshot.x,
    dy = ct.mouse.y - slingshot.y,
    l = ct.u.pdc(0, 0, dx, dy);
...
this.x = slingshot.x + dx;
this.y = slingshot.y + dy;
...
ct.templates.list['Alien_Dragging'] = [];
ct.templates.templates["elementMetal013"] = {
    depth: 0,
    blendMode: PIXI.BLEND_MODES.NORMAL,
    playAnimationOnStart: false,
    texture: "elementMetal013",
    onStep: function () {
        this.move();
    },
    onDraw: function () {
    ...
    extends: {
    "matterEnable": true,
    "matterConstraint": "pinpoint",
    "matterFrictionStatic": 0.1,
    "matterFrictionAir": 0.1,
    "matterDensity": 0.01,
    "matterRestitution": 0.6
}
};
ct.templates.list['elementMetal013'] = [];
ct.templates.templates["elementMetal011"] = {
    depth: 0,
    blendMode: PIXI.BLEND_MODES.NORMAL,
    playAnimationOnStart: false,
    texture: "elementMetal001",
    onStep: function () {
        this.move();
    },
    onDraw: function () {
...
ct.templates.list['elementMetal011'] = [];
ct.templates.templates["elementMetal000"] = {
    depth: 0,
    blendMode: PIXI.BLEND_MODES.NORMAL,
    playAnimationOnStart: false,
    texture: "elementMetal000",
    onStep: function () {
        this.move();
    },
    onDraw: function () {
...
ct.templates.list['elementMetal000'] = [];
...
(function resAddon(ct) {
    ...
    ct.res = {
        ...
        loadGame() {
            ...
            const tiledImages = [{"colored_grass":{"source":"./img/t0.png","shape":{"type":"rect","top":0,"bottom":1024,"left":0,"right":1024},"anchor":{"x":0,"y":0}}}][0];
            const sounds = [[{"name":"Impact_Wooden","wav":false,"mp3":false,"ogg":"./snd/ccfe7f50-d4d3-4570-95e9-75d5d73bef0a.ogg","poolSize":5,"isMusic":false},{"name":"Impact_Metal","wav":false,"mp3":false,"ogg":"./snd/cbca4dd5-7369-48d5-b3b7-e9b0055e2eda.ogg","poolSize":5,"isMusic":false},{"name":"Impact_Alien","wav":false,"mp3":false,"ogg":"./snd/3142b705-6de5-4f57-9b70-c9bc3fb4cdad.ogg","poolSize":5,"isMusic":false}]][0];
            const bitmapFonts = [{}][0];
