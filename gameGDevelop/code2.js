...
isConditionTrue_0 = gdjs.playerAuthentication.isAuthenticated();
if (isConditionTrue_0) {
{gdjs.evtTools.leaderboards.saveConnectedPlayerScore(runtimeScene, "4b94759f-a475-41e4-8096-7a992b894b62", gdjs.evtTools.variable.getVariableNumber(runtimeScene.getGame().getVariables().getFromIndex(0)));
}}
...
{gdjs.evtTools.leaderboards.savePlayerScore(runtimeScene, "4b94759f-a475-41e4-8096-7a992b894b62", gdjs.evtTools.variable.getVariableNumber(runtimeScene.getGame().getVariables().getFromIndex(0)), (( gdjs.LeaderboardCode.GDPlayerNameInputObjects3.length === 0 ) ? "" :gdjs.LeaderboardCode.GDPlayerNameInputObjects3[0].getText()));
...
let isConditionTrue_0 = false;
{
{gdjs.evtTools.leaderboards.displayLeaderboard(runtimeScene, "4b94759f-a475-41e4-8096-7a992b894b62", true);
...
if (isConditionTrue_0) {
isConditionTrue_0 = false;
isConditionTrue_0 = gdjs.evtTools.leaderboards.hasBeenSaved("4b94759f-a475-41e4-8096-7a992b894b62");
}
if (isConditionTrue_0) {
{gdjs.playerAuthentication.removeAuthenticationBanner(runtimeScene);
}{gdjs.evtTools.runtimeScene.replaceScene(runtimeScene, "Game", false);
...
let isConditionTrue_0 = false;
isConditionTrue_0 = false;
{isConditionTrue_0 = runtimeScene.getOnceTriggers().triggerOnce(11065748);
}
if (isConditionTrue_0) {
